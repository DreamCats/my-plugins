...
from renderer import ObsidianLarkDocRenderer
...
def main():
    parser = argparse.ArgumentParser(description="Export Lark doc to Obsidian Markdown")
    ...
    renderer = ObsidianLarkDocRenderer(
        items=items,
        doc_id=doc_id,
