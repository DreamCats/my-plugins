...
description: This skill should be used when the user asks to "lark add-permission", "添加飞书协作者", "授予飞书文档权限", or manage Lark doc permissions for users/groups/departments.
---
